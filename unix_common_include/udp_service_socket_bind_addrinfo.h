...
#ifndef __UDP_SERVICE_SOCKET_BIND_ADDRINFO_H
#define __UDP_SERVICE_SOCKET_BIND_ADDRINFO_H
...
int udp_socket_bind_config( struct sockaddr *sa_p,
...
#endif //__UDP_SERVICE_SOCKET_BIND_ADDRINFO_H
